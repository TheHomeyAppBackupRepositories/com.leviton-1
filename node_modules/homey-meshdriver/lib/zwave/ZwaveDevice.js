...
class ZwaveDevice extends MeshDevice {
  ...
  async _setCapabilityValue(capabilityId, commandClassId, value, opts = {}) {
    console.log('_setCapabilityValue');
  ...
  _registerCapabilitySet(capabilityId, commandClassId) {
    ...
    console.log(capabilityId, parsedPayload);
   ...
   * @returns {Promise<string|*>}
   */
  async executeCapabilitySetCommand(capabilityId, commandClassId, value, opts = {}) {  async executeCapabilitySetCommand(capabilityId, commandClassId, value, opts = {}) {
    console.log('executeCapabilitySetCommand 2');
    return this._setCapabilityValue(capabilityId, commandClassId, value, opts);
  }
